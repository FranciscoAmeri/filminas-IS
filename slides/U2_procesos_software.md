...
Incremento 2: Marcar ítems como comprados.
...
<!--Ejemplo:
Iteración 1: Prototipo básico solo con creación de listas → Riesgo: interfaz poco intuitiva → Solución: prueba rápida con usuarios.
Iteración 2: Agregar función de marcar ítems → Riesgo: pérdida de datos → Solución: implementar guardado automático.
-->
...
[Prototipo hecho en Adobe XD](https://xd.adobe.com/view/79dd4690-1c36-4223-9d53-c4d50d2463c9-2c8e/)
<small>*(Adobe XD está en modo mantenimiento desde 2023; el ejemplo sigue siendo válido como muestra de prototipo navegable.)*</small>
